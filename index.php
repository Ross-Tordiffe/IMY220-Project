<?php
    ...
    $scripts = "<script src='public_html/js/splash.js' defer></script><script src='public_html/js/vd-login.js' defer></script><script src='public_html/js/vd-signup.js' defer></script>";
